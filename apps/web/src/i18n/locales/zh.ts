...
export const zhMessages: LocaleMessages = {
    common: {
      ...
      featureDescriptionNotes: '在可回溯的写作空间里持续编辑内容，并把定稿一键导出成分享图。',
    ...
    useCasesHub: {
      ...
      description: '不同功能对应不同场景。需要写作、版本管理和分享图导出时用 WriteDeck，临时分享文字与文件时用 LinkDisk。',
      notesTitle: 'WriteDeck',
      notesDescription: '适合草稿、持续修改的内容、版本回看，以及最终导出分享图。',
      notesCta: '查看 WriteDeck 使用场景',
      notesAppCta: '打开 WriteDeck',
