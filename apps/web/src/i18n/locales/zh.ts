...
export const zhMessages: LocaleMessages = {
    ...
    useCasesHub: {
      ...
      metadataDescription: '查看 Notes 和 LinkDisk 各自适合的使用场景，然后进入最贴合当前任务的功能。',
      eyebrow: '产品场景总览',
      title: '先看清你要解决的问题，再进入对应的功能',
      description: '不同功能对应不同场景。写作、版本管理和分享图导出看 Notes，临时分享文字与文件看 LinkDisk。',
      notesTitle: 'Notes',
      notesDescription: '适合草稿、笔记、反复修改的内容，以及最终导出分享图。',
      notesCta: '查看 Notes 使用场景',
      notesAppCta: '打开 Notes',
    ...
    notes: {
      metadataTitle: '笔记编辑器',
      metadataDescription: '本地优先的笔记编辑器，支持自动保存、历史版本、回滚和分享图导出。',
      title: '笔记编辑器',
      description: '用纯文本或 Markdown 写内容，把版本记录留在本机，再导出成适合分享的图片。',
