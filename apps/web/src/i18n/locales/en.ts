...
export const enMessages: LocaleMessages = {
    ...
    useCasesHub: {
      ...
      metadataDescription: 'Explore use cases for Notes and LinkDisk, then jump into the product that fits your workflow.',
      eyebrow: 'Product use cases',
      title: 'Choose the workflow that matches what you need to do',
      description: 'Each product has its own use cases page. Start with writing and versioned notes, or jump into quick text and file sharing.',
      notesTitle: 'Notes',
      notesDescription: 'For drafts, notes, revision history, and turning finished writing into share images.',
      notesCta: 'Explore Notes use cases',
      notesAppCta: 'Open Notes',
    ...
    notes: {
      metadataTitle: 'Notes Editor',
      metadataDescription: 'Local-first notes editor with autosave, history, rollback, and share-image export.',
      title: 'Notes Editor',
      description: 'Write in plain text or Markdown, keep your history locally, and export polished share images without creating an account.',
