...
export const enMessages: LocaleMessages = {
    common: {
      ...
      featureDescriptionNotes: 'Write in a versioned workspace, keep every draft recoverable, and export polished share images.',
    ...
    useCasesHub: {
      ...
      notesDescription: 'For drafts, revision history, recoverable writing, and turning finished text into share images.',
      notesCta: 'Explore WriteDeck use cases',
      notesAppCta: 'Open WriteDeck',
