...
export const jaMessages: LocaleMessages = {
  common: {
    ...
    useCasesHub: {
      ...
      metadataDescription: 'Notes と LinkDisk の利用シーンを見比べて、今の作業に合うプロダクトへ進めます。',
      eyebrow: 'プロダクト別の利用シーン',
      title: 'やりたいことに合うワークフローを選ぶ',
      description: '各プロダクトには専用の利用シーンページがあります。執筆と版管理なら Notes、テキストとファイルの共有なら LinkDisk です。',
      notesTitle: 'Notes',
      notesDescription: '下書き、メモ、版管理、そして仕上げた文章の共有画像化に向いています。',
      notesCta: 'Notes の利用シーンを見る',
      notesAppCta: 'Notes を開く',
    ...
    notes: {
      metadataTitle: 'ノートエディタ',
      metadataDescription: 'ローカルファーストのノートエディタ。自動保存、履歴、復元、共有画像の書き出しに対応します。',
      title: 'ノートエディタ',
      description: 'プレーンテキストまたは Markdown で書き、このブラウザに履歴を残し、共有しやすい画像を書き出せます。',
