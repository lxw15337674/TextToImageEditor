...
export const jaMessages: LocaleMessages = {
  common: {
      ...
      featureDescriptionNotes: '版管理された執筆スペースで下書きを守り、仕上がった文章を共有画像として書き出せます。',
    ...
    useCasesHub: {
      ...
      notesDescription: '下書き、版管理、書き直しの多い文章、そして仕上げた内容の共有画像化に向いています。',
      notesCta: 'WriteDeck の利用シーンを見る',
      notesAppCta: 'WriteDeck を開く',
